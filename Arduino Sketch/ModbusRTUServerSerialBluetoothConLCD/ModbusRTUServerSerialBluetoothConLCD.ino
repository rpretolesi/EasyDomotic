...
#define  BT_RX 7            // PIN TO receive from bluetooth
#define  BT_TX 6            // PIN TO transmit to bluetooth
    ...
    if (byteModbusFunctionCode == 0x10) {
      ...
      if (bRegisterAndByteCountOk == true) {
        ...
        if (ushortModbusAddress + shortQuantityOfRegisters < 20) {
          ...
          // Print data read
//          // Serial.print("Short: Addr 0 ");
          union {
            short sh;
            byte shByteTemp[2];
          } ush_1;
          memcpy(ush_1.shByteTemp, &m_union_share_mem.temp_bytearray[0], 2);
          reverseByteArray(ush_1.shByteTemp, 0, 1);
//          // Serial.print(ush_1.sh);
           // LCD
          lcd.setCursor(0, 0);  
          lcd.print(ush_1.sh); 
 
          // Print data read
//          // Serial.print("Short: Addr 2 ");
          union {
            short sh;
            byte shByteTemp[2];
          } ush_2;
          memcpy(ush_2.shByteTemp, &m_union_share_mem.temp_bytearray[2], 2);
          reverseByteArray(ush_2.shByteTemp, 0, 1);
//          // Serial.print(ush_2.sh);
           // LCD
          lcd.setCursor(8, 0);  
          lcd.print(ush_2.sh); 
   
          // Print data read
//          // Serial.print("Short: Addr 4 ");
          union {
            short sh;
            byte shByteTemp[2];
          } ush_3;
          memcpy(ush_3.shByteTemp, &m_union_share_mem.temp_bytearray[4], 2);
          reverseByteArray(ush_3.shByteTemp, 0, 1);
//          // Serial.print(ush_3.sh);
           // LCD
          lcd.setCursor(0, 1);  
          lcd.print(ush_3.sh); 
  
         // Print data read
//          // Serial.print("Short: Addr 6 ");
          union {
            short sh;
            byte shByteTemp[2];
          } ush_4;
          memcpy(ush_4.shByteTemp, &m_union_share_mem.temp_bytearray[6], 2);
          reverseByteArray(ush_4.shByteTemp, 0, 1);
//          // Serial.print(ush_4.sh);
           // LCD
          lcd.setCursor(8, 1);  
          lcd.print(ush_4.sh); 
...
//          // Serial.println(" ");
 ...
 //         Serial.print("4");
        ...
        reverseByteArray(ush_1.shByteTemp, 0, 1);
        memcpy(&m_union_share_mem.temp_bytearray[6], ush_1.shByteTemp, sizeof(ush_1.shByteTemp));
